 ...
 * `load` is effective sets per muscle (see lib/muscles.ts); shading is relative to
 * the hardest-worked muscle in that same load, so it always reads as a balance.
 */
export default function BodyMap({ load = {}, body = 'male', onMuscle, selected, className = '' }: any) {
