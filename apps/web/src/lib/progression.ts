...
export function defaultIncrement(exId: any, unit?: any) {
  const ex = EXIDX[exId]
...
export function policyFor(cfg: any, routine?: any, mode?: any) {
 ...
 */
export function readSession(entry: any, fallback?: any) {
...
export function sessionsFor(S: any, exId: any, fallback?: any) {
  const out = []
 ...
 */
export function nextPrescription(S: any, cfg: any, routine?: any) {
