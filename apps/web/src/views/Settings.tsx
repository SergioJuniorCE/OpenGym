...
import { useStore, DEF, hasData } from '../store/useStore'
import { useUI } from '../store/useUI'
import { ACCENTS, todayISO, localTZ } from '../lib/format'
import { effortOf } from '../lib/history'
import { api, webauthnOK, passkeyLogin, passkeyRegister, IS_ANDROID } from '../lib/api'
import { pushSupported, enablePush, disablePush, sendTestPush } from '../lib/push'
import { wakeLockSupported } from '../lib/wakelock'
import { t, LANGS, INSTR_LANGS } from '../lib/i18n'
...
function NotificationsCard({ S, update, toast }: any) {
  return <PushCard S={S} update={update} toast={toast} />
}

function PushCard({ S, update, toast }: any) {
...
function RegisterInline({ close, setUser, pushState, pullState, toast }: any) {
